    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="Company" autocomplete="off" value="<?php echo $item->company;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        <div class="col-sm-3">
            <div class="form-material">
                <label class="control-label margin-top-10" for="">Phone <span class="text-danger">*</span>:</label>
            </div>
        </div>
        <div class="col-sm-9">
            <div class="form-material">
                <input type="text" class="form-control" id="" name="phone"
                placeholder="Phone" autocomplete="off" value="<?php echo $item->phone;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="Email" autocomplete="off" value="<?php echo $item->email;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        <div class="col-sm-3">
            <div class="form-material">
                <label class="control-label margin-top-10" for="">Address <span class="text-danger">*</span>:</label>
            </div>
        </div>
        <div class="col-sm-9">
            <div class="form-material">
                <input type="text" class="form-control" id="" name="address"
                placeholder="Address" autocomplete="off" value="<?php echo $item->address;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                <textarea class="form-control" id="content" name="besked"><?php echo $item->besked;?></textarea>
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
