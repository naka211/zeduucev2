        ...
        <div class="example">
            <form id="searchFrm" class="form-inline" method="post">
                <div class="form-group">
                    <input type="text" name="name" id="nameKey" autocomplete="off" placeholder="<?php echo lang('category.name');?>" class="form-control"/>
                </div>
                <div class="form-group">
            ...
            <table id="list_table"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="code"><?php echo lang('category.code');?></th>
                        <th data-field="name"><?php echo lang('category.name');?></th>
                        <th data-field="nameParent"><?php echo lang('category.name.parent');?></th>
                        <th data-field="dt_create"><?php echo lang('category.date');?></th>
...
<input type="hidden" name="table" value="content_category" />
