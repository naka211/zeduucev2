    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="<?php echo lang('access.module.code.function');?>" autocomplete="off" value="<?php echo $item->function_code;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="<?php echo lang('access.module.name.function');?>" autocomplete="off" value="<?php echo $item->function_name;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="<?php echo lang('access.module.description');?>" autocomplete="off" value="<?php echo $item->function_comment;?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
