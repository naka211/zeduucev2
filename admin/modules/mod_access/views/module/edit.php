    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="<?php echo lang('access.module.code.module');?>" autocomplete="off" value="<?php echo $item->module_code;?>"/>
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="<?php echo lang('access.module.name.module');?>" autocomplete="off" value="<?php echo $item->module_name; ?>" />
            </div>
        </div>
    </div>
    <div class="row margin-bottom-10">
        ...
        <div class="col-sm-9">
            <div class="form-material">
                ...
                placeholder="<?php echo lang('access.module.description');?>" autocomplete="off" value="<?php echo $item->module_comment;?>" />
            </div>
        </div>
    </div>
