    ...
    <div class="padding-left-10 padding-right-10 text-center">
        <div class="example">
            <form id="searchFrm" class="form-inline" method="post">
                ...
                <div class="form-group">
                    <a id="bnt-searchDrm" onclick="searchFrm('searchFrm','<?php echo site_url($this->module_name.'/product/search/');?>')" class="btn btn-primary waves-effect waves-light"><?php echo lang('admin.search');?></a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo form_open($this->module_name.'/product', array('class' => 'admin', 'id' => 'adminfrm'));?>
<div class="panel-body">
    <div class="row">
        <div class="col-sm-12">
            <div id="toolbar">
                <?php if($this->check->check('dels')){?>
                <a class="btn btn-danger" onclick="deleteAllItem('<?php echo site_url($this->module_name."/product/dels/");?>');" >
            ...
            <table id="list_table"
                data-toggle="table"
                data-url="<?php echo site_url($this->module_name.'/product/getContent');?>"
...
<input type="hidden" name="table" value="product_product" />
